...
class CheckAssetsTest(unittest.TestCase):
    ...
    def test_check_assets_are_served_with_correct_content_types(self):
        for filename in ["check-app.css", "check-app.js", "check-core.js", "check-worker.js", "sql-filter-tool.js", "vendor/xlsx.full.min.js"]:
    ...
    def test_static_mirror_matches_served_files(self):
        for filename in ["index.html", "styles.css", "app.js", "check-app.css", "check-app.js", "check-core.js", "check-worker.js", "sql-filter-tool.js", "vendor/xlsx.full.min.js"]:
